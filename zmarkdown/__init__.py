...
__all__ = ['ZMarkdown', 'zmarkdown']

logger = logging.getLogger('ZMARKDOWN')


class ZMarkdown(object):
        ...
        * configs: A dictionary mapping module names to config options.
        ...
        for ext in extensions:
            ...
            if isinstance(ext, Extension):
                ext.extendZMarkdown(self, globals())
                logger.debug('Successfully loaded extension "%s.%s".',
                             ext.__class__.__module__, ext.__class__.__name__)
            elif ext is not None:
                raise TypeError('Extension "%s.%s" must be of type: "zmarkdown.Extension"'
                                % (ext.__class__.__module__, ext.__class__.__name__))
    ...
    def build_extension(self, ext_name, configs):
        ...
        if pos > 0:
            ...
            warnings.warn('Setting configs in the Named Extension string is '
                          ...
                          'See the Release Notes for ZMarkdown version '
        ...
        try:
            ...
            module_name = '.'.join(['zmarkdown.extensions', ext_name])
            try:
                ...
                warnings.warn('Using short names for Markdown\'s builtin '
                              ...
                              'ZMarkdown version 2.6 for more info.' %
                ...
                try:
                    ...
                    warnings.warn('ZMarkdown\'s behavior of prepending "mdx_" '
                                  ...
                                  'See the Release Notes for EMarkdown '
    ...
    def convert(self, source):
        ...
        * source: Source text as a Unicode string.
        ...
        try:
            ...
            e.reason += '. -- Note: ZMarkdown only accepts unicode input!'
            raise
        ...
        if self.stripTopLevelTags:
            try:
                ...
                if output.strip().endswith('<%s />' % self.doc_tag):
                    ...
                    raise ValueError('ZMarkdown failed to strip top-level '
...
# =============================================================================
#
# Those are the only function we really mean to export: zmarkdown()


def zmarkdown(text, *args, **kwargs):
