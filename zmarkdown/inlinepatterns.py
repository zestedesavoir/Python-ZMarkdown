...
class Pattern(object):
    ...
    def __init__(self, pattern, zmarkdown_instance=None, not_in=()):
        """
        ...
        * pattern: A regular expression that matches a pattern
        ...
        self.not_in = not_in
        if zmarkdown_instance:
            self.zmarkdown = zmarkdown_instance
    ...
    def unescape(self, text):
        ...
        try:
            stash = self.zmarkdown.treeprocessors['inline'].stashed_nodes
...
class EscapePattern(Pattern):
    ...
    def handleMatch(self, m):
        char = m.group(2)
        if char in self.zmarkdown.ESCAPED_CHARS:
    ...
    def unescape(self, text):
        ...
        def get_stash(m):
            ...
            if value is not None:
                try:
                    return self.zmarkdown.serializer(value)
                except:
                    return '\%s' % value
...
class ReferencePattern(LinkPattern):
    ...
    def handleMatch(self, m):
        ...
        if idd not in self.zmarkdown.references:  # ignore undefined refs
            return None
        href, title = self.zmarkdown.references[idd]
